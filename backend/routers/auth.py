...
async def mygenie_login(credentials: UserLogin):
    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            # Note: Auto-sync of customers from MyGenie has been removed from login
            # Users should manually sync customers using the "Sync MyGenie" button in the Customers page
